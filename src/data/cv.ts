...
export const cv = {
  ...
  // **bold** marks the keywords a recruiter should catch when scanning
  summary:
  ...
  roles: [
    {
      ...
      highlights: [
        ...
        "**Lead and mentor**: oversee team members' work, conduct 1-to-1s, and facilitated a Senior Data Analyst's **transition to Data Engineer** by developing their Python, SQL, and Cloud skills.",
      ],
    },
    {
      title: "Data Engineer",
...
// Drops the **bold** markers for plain-text consumers (knowledge base, chat)
